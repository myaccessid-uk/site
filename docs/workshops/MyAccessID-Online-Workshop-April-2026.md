# Access Models Beyond Federated Identity Providers

The MyAccessID UK User Community is hosting a two-hour online workshop via Microsoft Teams on 28<sup>th</sup> April 2026 from 10:00 am to 12:00 pm.
...
| ------------ | --------- | ------------------------ |
| 10:00 | Introduction | — |
| 10:10 | Session 1 – Connector | University of Cambridge |
| 10:40 | Break | — |
| 10:45 | Session 2 – Challenge, or not, of getting a MyAccessID connection? | UCL |
| 11:15 | Break | — |
| 11:20 | Session 3 – How many attributes to fetch? And are they trustworthy and compliant? | University of Bristol |
...
This session covers the range of options available for solving the authentication problem. Topics include the email authenticator developed at Cambridge — a solution using Keycloak with professional email addresses for authentication — as well as per-organisation connections (e.g. Okta, Active Directory) as used by AISI and NCC to directly link Keycloak to their Identity Provider.
...
- **[Subscribe to the IAM4DRI mailing list][mail-registration-link]**

Or visit the mailing list homepage:
